...
\end{cverbatim}
\vspace{.3cm}
\centerline{\includegraphics[width=9cm]{./assets/fcfs.png}}
...
\end{cverbatim}
\vspace{.3cm}
\centerline{\includegraphics[width=9cm]{./assets/sstf.png}}
\vspace{.3cm}
\begin{cverbatim}
...
\end{cverbatim}
\vspace{.3cm}
\centerline{\includegraphics[width=9cm]{./assets/scan.png}}
\vspace{.3cm}
\begin{cverbatim}
...
\end{cverbatim}
\vspace{.3cm}
\centerline{\includegraphics[width=9cm]{./assets/cscan.png}}
\vspace{.3cm}
